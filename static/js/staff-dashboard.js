                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex justify-between items-start">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">Host: ${request.student__name} (Room ${request.student__room_number})</p>
                        ...
                        <div class="flex space-x-2 ml-4">
                            <button class="approve-btn bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm" 
                                    data-id="${request.id}" data-type="guest">
                                Approve
                            </button>
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-2 ml-4">
                            <button class="approve-btn bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm" 
                                    data-id="${request.id}" data-type="maintenance">
                                Assign
                            </button>
