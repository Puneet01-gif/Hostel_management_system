...
class GuestRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'guest_name', 'guest_phone', 'start_date', 'end_date', 'purpose',
            'status', 'auto_approved', 'approval_reason', 'approved_by',
            'approved_by_name', 'duration_days', 'is_short_stay',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'request_id', 'auto_approved', 'approved_by', 'created_at', 'updated_at'
        ]
...
class MaintenanceRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            'request_id', 'auto_approved', 'is_overdue', 'days_pending',
            'created_at', 'updated_at'
        ]
